...
def _training_model(ti):
    accuracy = uniform(0.1, 10.0) # Accuracy of the Model is Random (uniform method)
...
with DAG('xcom_dag', schedule_interval='@daily', default_args=default_args, catchup=False, tags=['bert']) as dag:
